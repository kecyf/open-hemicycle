...
| 4.8 | P0 | in-progress | **Couche d'enrichissement LLM** : … + **GRANTs oh_agent appliqués** + **650 classifications live** + cron ETL vert + seed taxonomie exécuté. Reste : secrets cloud agent (DATABASE_URL + OpenRouter), extension classify, relecture PR #19 |
