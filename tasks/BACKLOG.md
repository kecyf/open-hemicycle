...
| 0.4 | P0 | next | Squelette monorepo pnpm (`apps/web`, `packages/etl`, configs) |
| 0.5 | P0 | next | Repo GitHub public + push initial |
...
| ID | Prio | Statut | Tâche |
|----|------|--------|-------|
| 1.1 | P0 | next | Créer projet Supabase + connexion + `.env.example` |
| 1.2 | P0 | next | Schéma Drizzle + 1re migration (tables core) |
