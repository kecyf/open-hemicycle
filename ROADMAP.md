...
- [~] Migration des slugs pilotes vers taxonomie commissions — **couche web** (résolution + redirect canonique) livrée ; projection DB `seed:themes` en attente credentials.
