...
- [~] Couche d'enrichissement : classification scrutin → thème par LLM — **fondations + lecture atlas web + décompte source + fiche scrutin** livrées ; migration DB + run live en attente (HITL + secrets).
